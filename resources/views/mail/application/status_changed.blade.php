...
<head>
    ...
    <title>Application Result - {{ config('app.name') }}</title>
    <style>
    ...
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <div class="greeting">
                ...
                <p></p>
                @if($status === 'ACCEPTED')
                <p>Congratulations! Your application for the position of <strong>{{ $jobApplication->job->title }}</strong> has been accepted. Our team will contact you shortly to proceed with the next steps.</p>
                @elseif($status === 'REJECTED')
                <p>We regret to inform you that your application for the position of <strong>{{ $jobApplication->job->title }}</strong> has not been successful.</p>
                @else
