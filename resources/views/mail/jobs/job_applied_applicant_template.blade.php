...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            ...
            <p>Thank you for applying to {{ $jobApplication->job->title }} at {{ config('app.name') }}</p>
        </div>
        ...
        <div class="email-content">
            <!-- Greeting -->
            <div class="greeting">
                <p>Hello <strong>{{ $jobApplication->jobseeker->name }}</strong>,</p>
                <p>We've successfully received your application for the position of <strong>{{ $jobApplication->job->title }}</strong>.</p>
            </div>
            ...
            <div class="confirmation-card">
                ...
                <h2 style="font-size: 20px; font-weight: 700; color: #111827; margin-bottom: 12px;">
                    Your application #{{ $jobApplication->id }} is now under review
                </h2>
            </div>
            ...
            <div style="margin: 48px 0;">
                <h3 style="font-size: 20px; font-weight: 700; color: #111827; margin-bottom: 24px;">
                    What Happens Next?
                </h3>
                ...
                <div class="timeline">
                    <div class="timeline-item current">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>Our hiring team is reviewing your application and qualifications.</p>
                        </div>
                    </div>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <p>You'll be notified of the final hiring decision.</p>
                        </div>
                    </div>
                </div>
            </div>
